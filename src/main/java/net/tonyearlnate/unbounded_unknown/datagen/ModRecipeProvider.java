    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                ...
                createShapeless(RecipeCategory.TOOLS, ModItems.ENERGIZED_KITIUM_SWORD_FRAME)
                        .input(ModItems.PINK_KITIUM_SWORD)
                        .input(ModItems.BLUE_KITIUM_SWORD)
                ...
                createShapeless(RecipeCategory.TOOLS, ModItems.ENERGIZED_KITIUM_PICKAXE_FRAME)
                        .input(ModItems.PINK_KITIUM_PICKAXE)
                        .input(ModItems.BLUE_KITIUM_PICKAXE)
                        .input(ModItems.ENERGIZED_KITIUM)
                ...
                createShapeless(RecipeCategory.TOOLS, ModItems.ENERGIZED_KITIUM_AXE_FRAME)
                        .input(ModItems.PINK_KITIUM_AXE)
                        .input(ModItems.BLUE_KITIUM_AXE)
                        .input(ModItems.ENERGIZED_KITIUM)
                ...
                createShapeless(RecipeCategory.TOOLS, ModItems.ENERGIZED_KITIUM_SHOVEL_FRAME)
                        .input(ModItems.PINK_KITIUM_SHOVEL)
                        .input(ModItems.BLUE_KITIUM_SHOVEL)
                        .input(ModItems.ENERGIZED_KITIUM)
                ...
                createShapeless(RecipeCategory.TOOLS, ModItems.ENERGIZED_KITIUM_HOE_FRAME)
                        .input(ModItems.PINK_KITIUM_HOE)
                        .input(ModItems.BLUE_KITIUM_HOE)
                        .input(ModItems.ENERGIZED_KITIUM)
