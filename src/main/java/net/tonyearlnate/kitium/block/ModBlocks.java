...
public class ModBlocks {
    public static final Block PINK_KITIUM_BLOCK = registerBlock("pink_kitium_block",new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID ,"pink_kitium_block")))
    ...
    public static final Block BLUE_KITIUM_BLOCK = registerBlock("blue_kitium_block",new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID ,"blue_kitium_block")))
            .strength(4f).requiresTool().sounds(BlockSoundGroup.NETHERITE)));
    public static final Block ENERGIZED_KITIUM_BLOCK = registerBlock("energized_kitium_block",new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID ,"energized_kitium_block")))
    ...
    public static final Block RAW_PINK_KITIUM_BLOCK = registerBlock("raw_pink_kitium_block",new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID ,"raw_pink_kitium_block")))
    ...
    public static final Block RAW_BLUE_KITIUM_BLOCK = registerBlock("raw_blue_kitium_block",new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID ,"raw_blue_kitium_block")))
            .strength(2f).requiresTool().sounds(BlockSoundGroup.STONE)));
    public static final Block PINK_KITIUM_PANELING = registerBlock("pink_kitium_paneling",new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID ,"pink_kitium_paneling")))
    ...
    public static final Block BLUE_KITIUM_PANELING = registerBlock("blue_kitium_paneling",new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID ,"blue_kitium_paneling")))
            .strength(4f).requiresTool().sounds(BlockSoundGroup.COPPER)));
    public static final Block ENERGIZED_KITIUM_PANELING = registerBlock("energized_kitium_paneling",new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID ,"energized_kitium_paneling")))
    ...
    public static final Block WHITE_KITIUM_BLOCK = registerWhiteKitiumBlock(new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID ,"white_kitium_block")))
	...
	public static final Block PINK_KITIUM_ORE = registerBlock("pink_kitium_ore", new Block(AbstractBlock.Settings.create()
			.registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID, "pink_kitium_ore")))
	...
	public static final Block BLUE_KITIUM_ORE = registerBlock("blue_kitium_ore", new Block(AbstractBlock.Settings.create()
			.registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID, "blue_kitium_ore")))
    ...
    public static final Block DEEPSLATE_PINK_KITIUM_ORE = registerBlock("deepslate_pink_kitium_ore", new Block(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID, "deepslate_pink_kitium_ore")))
    ...
    public static final Block LIGHTNING_COLLECTOR = registerBlock("lightning_collector", new LightningCollectorBlock(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Kitium.MOD_ID, "lightning_collector")))
            .strength(4f).requiresTool().sounds(BlockSoundGroup.METAL)));
    
    private static Block registerBlock(String name, Block block) {
        registerBlockItem(name, block);
        return Registry.register(Registries.BLOCK, Identifier.of(Kitium.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(Kitium.MOD_ID, name), new BlockItem(block, new Item.Settings()
                .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(Kitium.MOD_ID, name))).useBlockPrefixedTranslationKey()));
    }

    private static Block registerWhiteKitiumBlock(Block block) {
        registerWhiteKitiumBlockItem(block);
        return Registry.register(Registries.BLOCK, Identifier.of(Kitium.MOD_ID, "white_kitium_block"), block);
    }

    private static void registerWhiteKitiumBlockItem(Block block) {
        Registry.register(Registries.ITEM, Identifier.of(Kitium.MOD_ID, "white_kitium_block"), new BlockItem(block, new Item.Settings().rarity(Rarity.EPIC)
                .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(Kitium.MOD_ID, "white_kitium_block"))).useBlockPrefixedTranslationKey()));
    }

    public static void registerModBlocks() {
        Kitium.LOGGER.info("Registering Mod Blocks for " + Kitium.MOD_ID);
