...
public record SoulSiphonEffect(EnchantmentLevelBasedValue amount) implements EnchantmentEntityEffect {
    public static final MapCodec<SoulSiphonEffect> CODEC = RecordCodecBuilder.mapCodec(      instance ->
            instance.group(
                    EnchantmentLevelBasedValue.CODEC.fieldOf("amount").forGetter(SoulSiphonEffect::amount)
            ).apply(instance, SoulSiphonEffect::new)
    );
